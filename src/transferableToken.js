...
class TransferableToken {
    constructor(web3, transactionProvider, contractOwner, ethSigner, contractAddress, accountPassword = "") {
        this.web3 = web3;
    ...
    deployContract(contractOwner, symbol = "SET", tokenName = "Transferable Meetup token", gas = 900000, gasPrice = 4000000000) {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            try {
                ...
                const wallet = new ethers_1.Wallet(await self.ethSigner.getPrivateKey(contractOwner), self.transactionProvider);
